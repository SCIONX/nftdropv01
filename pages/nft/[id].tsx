      ...
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        <header className="flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-full bg-cyan-400 px-4 py-2 text-xs font-bold text-white lg:px-5 lg:py-3 lg:text-base"
          >
        ...
        <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-0">
          ...
          <p className="pt-2 text-xl text-cyan-500">13 / 21 NFT's claimed</p>
        </div>

        {/* Mint Button */}
        <button
          title="Mint NFT"
          className="mt-10 h-16 w-full rounded-full bg-cyan-700 font-bold text-white"
        >
          Mint NFT (0.01 ETH)
        </button>
      </div>
